...
<div id="register-overlay" class="cr-overlay" style="display:none;">
    <div class="cr-popup">
        ...
        <div class="cr-header">
            <div class="cr-header-left">
                ...
                <div>
                    ...
                    <p class="cr-subtitle" id="cr-subtitle">Loading...</p>
                </div>
            </div>
            <div class="cr-header-right">
                <span class="cr-status-badge" id="cr-status-badge"></span>
        ...
        {{-- ── Open Register ── --}}
        <div id="cr-open-state" class="cr-body" style="display:none;">
            ...
            <div class="cr-info-row">
                ...
                <span class="cr-info-value" id="cr-datetime"></span>
            </div>

            <div class="cr-form-group">
                <label class="cr-label">Opening balance ($) <span class="cr-required">*</span></label>
                <input type="number" id="cr-opening-input" class="cr-input"
                       placeholder="0.00" step="0.01" min="0">
            </div>

            <div class="cr-form-group">
                <label class="cr-label">Note (optional)</label>
                <textarea id="cr-open-note" class="cr-textarea" placeholder="Any remark..."></textarea>
            </div>

            <button class="cr-btn cr-btn--open" id="cr-open-btn" onclick="submitOpenRegister()">
        ...
        {{-- ── Close Register ── --}}
        <div id="cr-close-state" class="cr-body" style="display:none;">

            {{-- Summary stats --}}
            <div class="cr-stat-grid">
                <div class="cr-stat">
                    <div class="cr-stat-label">Total transactions</div>
                    <div class="cr-stat-value" id="cr-total-txn">—</div>
                </div>
                <div class="cr-stat">
                    <div class="cr-stat-label">Total sales</div>
                    <div class="cr-stat-value" id="cr-total-sales">—</div>
                </div>
                <div class="cr-stat">
                    <div class="cr-stat-label">Opening balance</div>
                    <div class="cr-stat-value" id="cr-show-opening">—</div>
                </div>
                <div class="cr-stat">
                    <div class="cr-stat-label">Expected balance</div>
                    <div class="cr-stat-value" id="cr-expected">—</div>
                </div>
            </div>
            ...
            <div class="cr-info-row">
                ...
                <span class="cr-info-value" id="cr-opened-at">—</span>
            </div>

            <div class="cr-form-group">
                <label class="cr-label">Closing balance ($) <span class="cr-required">*</span></label>
                <input type="number" id="cr-closing-input" class="cr-input"
                       placeholder="Count and enter cash in drawer"
                       step="0.01" min="0" oninput="calcDifference()">
            </div>

            {{-- Difference --}}
            <div class="cr-diff-box" id="cr-diff-box">
                <span class="cr-diff-label">Difference</span>
                <span class="cr-diff-value" id="cr-diff-value">—</span>
            </div>

            <div class="cr-form-group">
                <label class="cr-label">Note (optional)</label>
                <textarea id="cr-close-note" class="cr-textarea"
                          placeholder="Reason for difference or any remark..."></textarea>
            </div>

            <button class="cr-btn cr-btn--close" id="cr-close-btn" onclick="submitCloseRegister()">
